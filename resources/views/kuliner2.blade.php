...
<div style="margin-inline-start: 2.5%; margin-top:2%; text-align: justify; margin-right:2%;">
  ...
  <p class="paragraph1">
    Taco, makanan yang begitu sederhana namun memiliki kelezatan tak tertandingi, telah menjadi ikon kuliner Meksiko yang mendunia. 
    Dengan berbagai pilihan isian, saus, dan tekstur, taco telah menyatukan lidah-lidah dari berbagai belahan dunia. 
    Mari kita menggali lebih dalam ke dalam sejarah yang terkandung dalam setiap gigitan taco, memahami bagaimana makanan 
    ini menjadi begitu melekat dalam identitas kuliner Meksiko.
  </p>
  ...
  <p>
    ...
    <p class="paragraph1">
      Taco memiliki akar yang dalam dalam sejarah Meksiko dan diyakini telah ada sejak zaman pra-Kolumbus. Para ahli sejarah makanan mencatat bahwa 
      penduduk asli Meksiko, khususnya suku Aztek, Toltek, dan Maya, menggunakan berbagai jenis tepung dan maizena (jagung) untuk membuat roti 
      pipih yang disebut "tlaxcalli" atau "tortilla." Tortilla inilah yang menjadi basis untuk apa yang kita kenal sebagai taco saat ini.
    </p>
    ...
    <p>
      ...
      <p class="paragraph1">
        Ekspansi global taco dimulai ketika imigran Meksiko membawa warisan kuliner mereka ke Amerika Serikat pada abad ke-19. 
        Meskipun awalnya dianggap sebagai makanan untuk kelas pekerja, taco dengan cepat meraih popularitas di kalangan masyarakat dan 
        menjadi ikon kuliner Meksiko di seluruh dunia. Restoran-restoran Meksiko dan food truck yang menyajikan taco menjadi destinasi 
        kuliner yang diminati.
      </p>
      <p class="paragraph2">
        Taco adalah lebih dari sekadar hidangan Meksiko, itu adalah penceritaan kreativitas, sejarah, dan keberagaman Meksiko yang diwujudkan 
        dalam sebuah sajian. Setiap gigitan taco membawa kita pada perjalanan melintasi waktu dan ruang, mengungkapkan kekayaan budaya yang 
        dihargai oleh para penikmatnya. Tak heran jika taco tetap memegang peranan penting dalam dunia kuliner internasional dan menjadi salah 
        satu makanan yang paling disukai di dunia.
      </p>
</div>
